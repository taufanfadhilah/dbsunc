        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4 ">
                    ...
                    <div class="card-body">
                        <form action="{{ url('perencanaan/'.$perencanaan->id) }}" method="post" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label>NAMA PEKERJAAN</label>
                                <input type="text" name="nama_paket" value="{{ old('nama_paket', $perencanaan->nama_paket) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="bidang" value="{{ old('bidang', $perencanaan->bidang) }}"
                                ...
                                <select name="bangunan_id" class="form-control @error('bangunan_id') is-invalid @enderror">
                                    ...
                                    @foreach ($bangunan as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('bangunan_id', $perencanaan->bangunan_id) == $item->id ? 'selected' : null }}>
                            ...
                            <div class="form-group">
                                <label>LOKASI</label>
                                <input type="text" name="lokasi" value="{{ old('lokasi', $perencanaan->lokasi) }}"
                            ...
                            <div class="form-group">
                                <label>NAMA</label>
                                <input type="text" name="nama" value="{{ old('nama', $perencanaan->nama) }}"
                                    class="form-control @error('nama') is-invalid @enderror">
                                @error('nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <label>ALAMAT/TELP</label>
                                <input type="text" name="alamat" value="{{ old('alamat', $perencanaan->alamat) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor" value="{{ old('nomor', $perencanaan->nomor) }}"
                                ...
                                <input type="number" name="nilai" value="{{ old('nilai', $perencanaan->nilai) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="mulai" value="{{ old('mulai' , $perencanaan->mulai) }}"
                            ...
                            <div class="form-group">
                                <label>KONTRAK</label>
                                <input type="date" name="selesai" value="{{ old('selesai', $perencanaan->selesai) }}"
                                    class="form-control @error('selesai') is-invalid @enderror">
                                @error('selesai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <label>BERITA ACARA SERAH TERIMA</label>
                                <input type="date" name="selesai_BAP" value="{{ old('selesai_BAP', $perencanaan->selesai_BAP) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="bast_id" class="form-control @error('bast_id') is-invalid @enderror">
                                    ...
                                    @foreach ($bast as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('bast_id', $perencanaan->bast_id) == $item->id ? 'selected' : null }}>{{ $item->status }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('bast_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="dokkontrak_pr" value="{{$perencanaan->dokkontrak_pr}}"
