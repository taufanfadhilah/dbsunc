        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4 ">
                    ...
                    <div class="card-body">
                        <form action="{{ url('pengawasan') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="dokkontrak_pw" value="{{ old('dokkontrak_pw') }}"
                                    class="form-control @error('dokkontrak_pw') is-invalid @enderror" onchange="loadFile(event)">
