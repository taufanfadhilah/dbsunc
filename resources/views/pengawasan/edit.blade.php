        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4 ">
                    ...
                    <div class="card-body">
                        <form action="{{ url('pengawasan/'.$pengawasan->id) }}" method="post" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label>NAMA PEKERJAAN</label>
                                <input type="text" name="nama_paket" value="{{ old('nama_paket', $pengawasan->nama_paket) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="bidang" value="{{ old('bidang', $pengawasan->bidang) }}"
                                ...
                                <select name="bangunan_id" class="form-control @error('bangunan_id') is-invalid @enderror">
                                    ...
                                    @foreach ($bangunan as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('bangunan_id', $pengawasan->bangunan_id) == $item->id ? 'selected' : null }}>
                            ...
                            <div class="form-group">
                                <label>LOKASI</label>
                                <input type="text" name="lokasi" value="{{ old('lokasi', $pengawasan->lokasi) }}"
                            ...
                            <div class="form-group">
                                <label>NAMA</label>
                                <input type="text" name="nama" value="{{ old('nama', $pengawasan->nama) }}"
                                    class="form-control @error('nama') is-invalid @enderror">
                                @error('nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <label>ALAMAT/TELP</label>
                                <input type="text" name="alamat" value="{{ old('alamat', $pengawasan->alamat) }}"
                            ...
                            <div class="form-group">
                                <label>NOMOR</label>
                                <small style="color: red;"><br>Untuk pengawasan Yang tidak ada Nomor kontrak mohon ditulis
                                    SC/PR/0001 , SC/PR/0002, dst.</small>
                                <input type="text" name="nomor" value="{{ old('nomor', $pengawasan->nomor) }}"
                                ...
                                <input type="number" name="nilai" value="{{ old('nilai', $pengawasan->nilai) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="mulai" value="{{ old('mulai' , $pengawasan->mulai) }}"
                            ...
                            <div class="form-group">
                                <label>KONTRAK</label>
                                <input type="date" name="selesai" value="{{ old('selesai', $pengawasan->selesai) }}"
                                    class="form-control @error('selesai') is-invalid @enderror">
                                @error('selesai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <label>BERITA ACARA SERAH TERIMA</label>
                                <input type="date" name="selesai_BAP" value="{{ old('selesai_BAP', $pengawasan->selesai_BAP) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="bast_id" class="form-control @error('bast_id') is-invalid @enderror">
                                    ...
                                    @foreach ($bast as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('bast_id', $pengawasan->bast_id) == $item->id ? 'selected' : null }}>{{ $item->status }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('bast_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="dokkontrak_pw" value="{{$pengawasan->dokkontrak_pw}}"
                                    class="form-control" onchange="loadFile(event)">
                                    <img id="output" src="{{asset('storage/'.$pengawasan->dokkontrak_pw)}}" style="max-width:110px;margin-top:20px;" />
                            </div>
                            <div class="form-group">
