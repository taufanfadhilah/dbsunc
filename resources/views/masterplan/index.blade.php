                                    ...
                                    @foreach ($masterplan as $items)
                                        <tr>
                                            ...
                                            <th class="text-center">
                                                <a href="{{ url('masterplan/' . $items->id) }}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ url('masterplan/' . $items->id.'/edit') }}"
                                                    class="btn btn-primary btn-sm">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <form action="{{ url('masterplan/' . $items->id) }}" method="post"
