        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4 ">
                    ...
                    <div class="card-body">
                        <form action="{{ url('masterplan') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="dokkontrak_mp" value="{{ old('dokkontrak_mp') }}"
                                    class="form-control @error('dokkontrak_mp') is-invalid @enderror" onchange="loadFile(event)">
