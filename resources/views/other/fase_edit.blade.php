        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4 ">
                <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-1">
                    ...
                    <a href="{{route('fase.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{route('fase.update', $fase->id)}}" method="post">
                        ...
                        <input type="text" name="fase"  class="form-control" value="{{ $fase->fase }}" autofocus required>
                    </div>
                    <div class="form-group">
                        <label>desc</label>
                        <textarea name="desc" class="form-control" >{{ $fase->desc }}</textarea>
                    </div>
