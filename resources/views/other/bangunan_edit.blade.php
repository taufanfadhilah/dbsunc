    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4 ">
                ...
                <div class="card-body">
                    <form action="{{route('bangunan.edit_process', $bangunan->id)}}" method="post">
                        @method('patch')
                        @csrf
                        <div class="form-group">
                        <label>Jenis / Fasilitas Bangunan</label>
                     
                        <input type="text" name="bangunan"  class="form-control" value="{{ $bangunan->bangunan }}" autofocus required>
                    </div>
                    <div class="form-group">
                        <label>desc</label>
                        <textarea name="desc" class="form-control" >{{ $bangunan->desc }}</textarea>
                    </div>
